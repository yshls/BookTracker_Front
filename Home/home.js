...
function getBookDesc(index) {
  switch (index) {
    case 0:
      return `<img src="../Home/img/reading.png" class="img-book">지금 읽고 있는 책을 등록해보세요 `;
    case 1:
      return `<img src="../Home/img/done.png" class="img-book">다 읽은 책을 등록해보세요`;
    case 2:
      return `<img src="../Home/img/book-together.png" class="img-book">읽고 싶은 책을 등록해보세요`;
  }
}
